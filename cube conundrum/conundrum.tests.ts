import {trebuchet} from "../trebuchet/trebuchet";
import {conundrum, minimumConundrumPower} from "./conundrum";
...
const puzzle = `Game 1: 20 green, 3 red, 2 blue; 9 red, 16 blue, 18 green; 6 blue, 19 red, 10 green; 12 red, 19 green, 11 blue
...
describe('conundrum', () => {
    test('example simple', () => {
        const number = conundrum(example, {
            green: 13,
            red: 12,
            blue: 14,
        });
    ...
    test('example minimal power', () => {
        const number = minimumConundrumPower(example);
        expect(number).toBe(2286);
    });

    test('puzzle', () => {
        const number = conundrum(puzzle, {
            green: 13,
            red: 12,
            blue: 14,
        });
    ...
    test('puzzle minimal power', () => {
        const number = minimumConundrumPower(puzzle);
        console.log(number)
    });
});