...
const puzzle = `eighttkbtzjz6nineeight
...
describe('testing index file', () => {
    test('trebuchet example 1', () => {
        const number = trebuchet(example);
        expect(number).toBe(142);
    });

    test('trebuchet example 2', () => {
        const number = trebuchet(example2);
        expect(number).toBe(281);
    });

    test('puzzle', () => {
        const number = trebuchet(puzzle);
        console.log(number)
    });
});