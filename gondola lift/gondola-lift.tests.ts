import {gearRatio, gondolaLift} from "./gondola-lift";
...
describe('testing index file', () => {
    ...
    test('gear ratio example 1', () => {
        const number = gearRatio(example);
        expect(number).toBe(467835);
    });
    ...
    test('puzzle gearRatio', () => {
        const number = gearRatio(puzzle);
        console.log(number)
    });
});